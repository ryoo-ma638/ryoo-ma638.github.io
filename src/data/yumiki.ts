...
// keyBonds  = 中心の相関図に“線”で結ぶ、特に縁の深い人たち（関係ラベル付き）。
// generations = 世代別の現役メンバー全員。rel/bond があれば縁の深い人としてハイライト。
// groups   = 卒業生・高校の同級生・坂道研修生の同期（他グループ）・番組など別枠のつながり。
export const relations = {
  ...
  groups: [
    ...
    {
      group: "坂道研修生の同期（他グループ）", color: "var(--y-peach)",
      people: [
        { name: "大沼 晶保", role: "櫻坂46", rel: "研修生同期", note: "坂道研修生の同期。『ラヴィット!』でも共演し、弓木さんを「お姉さんでしっかり者」「根が優しい」と評価。" },
        { name: "増本 綺良", role: "櫻坂46", rel: "研修生同期", note: "研修生時代のムードメーカー。元研修生の同窓会の幹事候補に弓木さんが名を挙げた。" },
        { name: "森本 茉莉", role: "日向坂46", rel: "研修生同期", note: "坂道研修生時代からの同期。" },
        { name: "髙橋 未来虹", role: "日向坂46", rel: "研修生同期", note: "研修生同期。弓木さんに同期会の“幹事”を頼んでいる。" },
        { name: "中嶋 優月", role: "櫻坂46", rel: "番組で交流", note: "公式ブログで、弓木さんと「ずっと笑いながら話した」「優しく接してくれて嬉しかった」と綴った後輩。" },
      ],
    },
    {
      ...
      people: [
        ...
        { name: "川島 明（麒麟）", role: "ラヴィット! MC", rel: "警戒からの信頼", note: "当初は「メッチャ警戒してた」が「結局正解を出し続けた」と信頼。料理の生披露で「ゆみっきー」がトレンド入り。" },
