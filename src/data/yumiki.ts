...
// 人物相関：弓木さんのつながり（公開情報ベース・事実のみ）
export const relations = [
  {
    group: "特に仲が良いメンバー",
    color: "var(--y-pink)",
    people: [
      { name: "遠藤 さくら", role: "乃木坂46 4期生", note: "2人旅番組『乃木坂、逅避行。』で島根・鳥取へ。4期生としての思いを語り合う間柄。" },
      { name: "賀喜 遥香", role: "乃木坂46 4期生", note: "田村真佑とともに3人で旅行に行く仲良しトリオ。" },
      { name: "田村 真佑", role: "乃木坂46 4期生", note: "賀喜遥香との旅行仲間。櫻坂46・中嶋優月とも交流がある。" },
      { name: "筒井 あやめ", role: "乃木坂46 4期生", note: "軍団「首ンセス」をともに組む同期。" },
    ],
  },
  {
    group: "頼れる3期生の先輩",
    color: "var(--y-sky)",
    people: [
      { name: "与田 祐希", role: "3期生（卒業）", note: "「祐希ちゃん」と呼び合うほど深い親交。卒業コンサートも見届けた、特別な先輩。" },
      { name: "梅澤 美波", role: "3期生・前キャプテン（卒業）", note: "全国ツアーで「みんなで梅澤さんをギュッと」と呼びかけ、キャプテンを感激させたエピソードも。" },
      { name: "久保 史緒里", role: "3期生", note: "頼れる3期生の先輩。番組や現場でお世話になっている。" },
    ],
  },
  {
    group: "“新4期生”（同時配属の同期）",
    color: "var(--y-lav)",
    people: [
      { name: "黒見 明香", role: "新4期生", note: "" },
      { name: "佐藤 璃果", role: "新4期生", note: "" },
      { name: "林 瑠奈", role: "新4期生", note: "" },
      { name: "松尾 美佑", role: "新4期生", note: "坂道研修生から弓木と同時に乃木坂46へ配属された“新4期生”の仲間。" },
    ],
  },
  {
    group: "慕ってくれる後輩（6期生）",
    color: "var(--y-butter)",
    people: [
      { name: "小津 玲奈", role: "6期生", note: "弓木さんを慕う後輩。雰囲気やトークのテンポが似ていると、ファンの間でも話題に。" },
    ],
  },
  {
    group: "他グループの友達",
    color: "var(--y-mint)",
    people: [
      { name: "中嶋 優月", role: "櫻坂46 3期生", note: "田村真佑とともに仲が良く、ツーショットも公開されている。" },
  ...
  },
  {
    ...
    color: "var(--y-butter)",
    people: [
      { name: "和田 まあや", role: "乃木坂46 1期生（卒業）", note: "なんと高校の同級生。学生時代の思い出を共有する間柄。" },
