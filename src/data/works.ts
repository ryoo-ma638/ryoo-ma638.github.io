...
export const works: Work[] = [
  ...
  },
  {
    ...
    category: "web",
    summary: "乃木坂46・弓木奈於さんの魅力を、ファン目線でめいっぱい詰め込んだ非公式ファンサイト。「推し活ノート」のようなスクラップブックの世界観で、プロフィール・魅力・思い出・つながり（相関図）・ことば・写真までを一冊にまとめた。デザインから実装まで、一人で手がけている。",
    goal: "「好き」という気持ちを、そのままWebの体験に。弓木さんの魅力が、初めて知る人にも自然と伝わるサイトをめざした。（非公式ファンサイトとして、著作権・肖像権に配慮して制作）",
    approach: "ポートフォリオ本体のダーク基調とは対照的に、クリーム色とパステルの可愛い世界観で全面設計。流れる見出し、誕生日カウントダウン、人物相関図、写真のライトボックスなど「めくって楽しい」仕掛けを実装。情報は読みやすく整理しつつ、推し活ならではの高揚感を表現した。",
    slideGroups: [
      { title: "トップ — 最新情報と、各ページへのインデックス設計", images: ["/assets/works/yumiki/home.jpg"] },
      { title: "プロフィール — デビューから辿る活動年表", images: ["/assets/works/yumiki/profile.jpg"] },
      { title: "ことば — 名言・名場面をカードで紹介", images: ["/assets/works/yumiki/words.jpg"] },
    ],
