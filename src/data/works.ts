...
export const works: Work[] = [
  ...
  },
  {
    ...
    approach: "傘のシャフトに前向き・横向きのカメラを付け、雨筋の傾きから雨の向きを直接推定（Python / OpenCV。合成雨でのテストで角度誤差±0.3°）。2軸サーボで傘を向け、IMUで車椅子の傾き・旋回を毎秒10〜30回補正する設計。水野慎士研究室での個人研究として、WISS2026（インタラクティブシステムとソフトウェアのワークショップ）への応募を準備している段階。",
  ...
  },
  {
    ...
    category: "imaging",
    status: "構想中",
    summary: "福岡市科学館の展示アイデア公募（テーマ「生きもののコミュニケーション」）への応募企画。受賞すれば館内に体験型展示として設置される。",
    goal: "科学を“体で感じて学べる”体験に。1人・約5分で、生きもののコミュニケーションを直感的に楽しめる展示をめざす。",
    approach: "本命案は「植物のボディガードを呼べ！」——動けない植物になりきり、毛虫の食害に“においのSOS”を出して天敵バチを呼ぶ体験。ほかに「コウイカの腕振り手話」「植物のうわさ話（におい電話）」など、7案→3案に絞り、科学的根拠と差別化を調査している段階。水野慎士研究室での個人企画。",
    thumb: "/assets/works/fukuoka-idea.jpg",
  },
  {
    slug: "shuwa-game",
    title: "手話認識ゲーム",
  ...
  },
  {
    ...
    category: "web",
    status: "公開中・開発中",
    summary: "坂道系の「ミーグリ」を本番そっくりに練習できるWebアプリ。緊張も通信ラグも推しの反応も再現し、AIとの会話で“場数”を踏める。企画から実装まで一人で。",
  ...
  // ====================== 企画・発表（スライド制作・プレゼン・企画） ======================
  {
    ...
    title: "プレゼン・スライド制作",
    category: "planning",
    summary: "発表やサークルで登壇したスライド。『CEED新入生説明会』『Amazon Prime CM分析WS』を例に、情報の優先順位と“伝わる見せ方”を設計した。",
