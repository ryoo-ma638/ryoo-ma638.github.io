...
export const works: Work[] = [
  ...
  {
    slug: "robot-argus",
    title: "オリジナル3DCGロボット「ARGUS-LAZARUS」",
    category: "cg",
    summary: "Mayaでモデリングからアニメーションまで手がけたオリジナルのヒーロー型ロボット「アルゴス・ラザロ」。ジャンプ・キックのアクションを付け、After Effectsで空中シーンに仕上げた。",
    goal: "一体のキャラクターを、設定からモデリング・動きまで一貫して作り上げる。",
    approach: "頭部センサー・背面装甲・脚部機構などのディテールを設計し、Mayaでモデリング〜リギング〜アニメーション。機体名や仕様といった設定資料も作り込み、After Effectsで青空を背景にした空中アクションのカットに仕上げた。",
